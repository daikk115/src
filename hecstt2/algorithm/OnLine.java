...
public class OnLine extends Algorithm {
	...
	public boolean isInBigCell(SubCell checkCell, SubCell bigCell) {
		// return (((checkCell.column == bigCell.column) && (checkCell.row ==
		// bigCell.row))
		// || ((checkCell.column == bigCell.column) && (checkCell.row ==
		// bigCell.row - 1))
		// || ((checkCell.column == bigCell.column - 1) && (checkCell.row ==
		// bigCell.row)) || ((checkCell.column == bigCell.column - 1) &&
		// (checkCell.row - 1 == bigCell.row - 1)));
